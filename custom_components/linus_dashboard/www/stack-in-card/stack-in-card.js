...
function t(t, e, n, s) {
  var i,
    r = arguments.length,
    o = r < 3 ? e : null === s ? (s = Object.getOwnPropertyDescriptor(e, n)) : s;
  if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
    o = Reflect.decorate(t, e, n, s);
  else
    for (var a = t.length - 1; a >= 0; a--)
      (i = t[a]) && (o = (r < 3 ? i(o) : r > 3 ? i(e, n, o) : i(e, n)) || o);
        ...
        if ((u++, 1 === t.nodeType)) {
          if (t.hasAttributes()) {
            const e = t.attributes,
              { length: n } = e;
            let s = 0;
            for (let t = 0; t < n; t++) a(e[t].name, '$lit$') && s++;
            for (; s-- > 0; ) {
              const e = p[h],
                n = c.exec(e)[2],
                s = n.toLowerCase() + '$lit$',
              ...
              t.removeAttribute(s);
              const o = i.split(r);
              (this.parts.push({ type: 'attribute', index: u, name: n, strings: o }),
                (h += o.length - 1));
            }
          }
          ...
          if (t.data === s) {
            ...
            ((null !== t.previousSibling && u !== l) || (u++, e.insertBefore(d(), t)),
              (l = u),
              this.parts.push({ type: 'node', index: u }),
              null === t.nextSibling ? (t.data = '') : (n.push(t), u--),
              h++);
          } else {
            let e = -1;
...
function u(t, e) {
  ...
  for (; i.nextNode(); ) {
    ...
    for (
      ...
      ((o.index = null !== c ? -1 : o.index - l), (r = p(s, r)), (o = s[r]));
  }
  ...
  _clone() {
    ...
    for (; o < s.length; )
      if (((r = s[o]), l(r))) {
        for (; a < r.index; )
          (a++,
            'TEMPLATE' === d.nodeName && (n.push(d), (i.currentNode = d.content)),
            null === (d = i.nextNode()) && ((i.currentNode = n.pop()), (d = i.nextNode())));
        if ('node' === r.type) {
...
class w {
  ...
  getHTML() {
    ...
    for (let r = 0; r < t; r++) {
      ...
      const a = c.exec(t);
      e += null === a ? t + (n ? S : i) : t.substr(0, a.index) + a[1] + a[2] + '$lit$' + a[3] + s;
    }
...
class x {
  ...
  _getValue() {
    ...
    for (let i = 0; i < e; i++) {
      ...
      if (void 0 !== e) {
        const t = e.value;
        if (b(t) || !C(t)) s += 'string' == typeof t ? t : String(t);
...
const D = t => t && (k ? { capture: t.capture, passive: t.passive, once: t.once } : t.capture);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */ function V(t) {
  ...
  return (
    (n = e.keyString.get(i)),
    void 0 === n && ((n = new o(t, t.getTemplateElement())), e.keyString.set(i, n)),
...
(class {
  handleAttributeExpressions(t, e, n, s) {
    ...
    if ('@' === i) return [new A(t, e.slice(1), s.eventContext)];
    if ('?' === i) return [new M(t, e.slice(1), n)];
    return new x(t, e, n).parts;
  }
...
const I = t => e => {
    ...
    if (((r = i.keyString.get(a)), void 0 === r)) {
      ...
      (j && window.ShadyCSS.prepareTemplateDom(n, t), (r = new o(e, n)), i.keyString.set(a, r));
    }
  ...
  q = (t, e, n) => {
    ...
    (n
      ? (function (t, e, n = null) {
          ...
          if (null == n) return void s.appendChild(e);
          ...
          for (; r.nextNode(); )
            for (
              l++, r.currentNode === n && ((a = h(e)), n.parentNode.insertBefore(e, n));
              -1 !== o && i[o].index === l;
            ) {
              if (a > 0) {
                for (; -1 !== o; ) ((i[o].index += a), (o = p(i, o)));
                return;
              }
              o = p(i, o);
            }
...
const L = {
  ...
  $ = (t, e) => e !== t && (e == e || t == t),
  B = { attribute: !0, type: String, converter: L, reflect: !1, hasChanged: $ };
class W extends HTMLElement {
  ...
  static get observedAttributes() {
    ...
    return (
      this._classProperties.forEach((e, n) => {
        ...
        void 0 !== s && (this._attributeToPropertyMap.set(s, n), t.push(s));
      }),
      t
    );
  }
  ...
  static getPropertyDescriptor(t, e, n) {
    return {
      ...
      set(s) {
        const i = this[t];
        ((this[e] = s), this.requestUpdateInternal(t, i, n));
      },
      configurable: !0,
      enumerable: !0,
    };
  ...
  static _propertyValueToAttribute(t, e) {
    ...
    const n = e.type,
      s = e.converter;
    return ((s && s.toAttribute) || L.toAttribute)(t, n);
  }
  initialize() {
    ((this._updateState = 0),
  ...
  _propertyToAttribute(t, e, n = B) {
    const s = this.constructor,
      i = s._attributeNameForProperty(t, n);
    if (void 0 !== i) {
  ...
  _attributeToProperty(t, e) {
    ...
    const n = this.constructor,
      s = n._attributeToPropertyMap.get(t);
    if (void 0 !== s) {
  ...
  static _getUniqueStyles() {
    ...
    if (Array.isArray(t)) {
      const e = (t, n) => t.reduceRight((t, n) => (Array.isArray(n) ? e(n, t) : (t.add(n), t)), n),
        n = e(t, new Set()),
        s = [];
      (n.forEach(t => s.unshift(t)), (this._styles = s));
  ...
  (et.render = (t, e, s) => {
    ...
    if (
      (((t, e, s) => {
        ...
        (void 0 === i &&
          (n(e, e.firstChild),
          R.set(e, (i = new N(Object.assign({ templateFactory: V }, s)))),
          i.appendInto(e)),
          i.setValue(t),
          i.commit());
      })(t, l, Object.assign({ templateFactory: I(i) }, s)),
      a)
    ) {
      const t = R.get(l);
      R.delete(l);
      const s = t.value instanceof y ? t.value.template : void 0;
      (q(i, l, s), n(e, e.firstChild), e.appendChild(l), R.set(e, t));
    }
...
var it,
  rt = /d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,
  ot = '[^\\s]+',
  at = /\[([^]*?)\]/gm;
function lt(t, e) {
  for (var n = [], s = 0, i = t.length; s < i; s++) n.push(t[s].substr(0, e));
  return n;
}
var dt = function (t) {
  return function (e, n) {
...
var ut = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
  ...
  _t = {
    ...
    ZZ: function (t) {
      ...
      return (e > 0 ? '-' : '+') + gt(100 * Math.floor(Math.abs(e) / 60) + (Math.abs(e) % 60), 4);
    },
    Z: function (t) {
      var e = t.getTimezoneOffset();
      return (
        (e > 0 ? '-' : '+') + gt(Math.floor(Math.abs(e) / 60), 2) + ':' + gt(Math.abs(e) % 60, 2)
      );
    },
  },
  yt = function (t) {
...
var xt = function (t, e, n) {
    ...
    var s = [];
    e = (e = Ct[e] || e).replace(at, function (t, e) {
      return (s.push(e), '@@@');
    });
    var i = ct(ct({}, ft), n);
    return (e = e.replace(rt, function (e) {
      return _t[e](t, i);
    })).replace(/@@@/g, function () {
      return s.shift();
    });
  ...
  Mt = function (t, e) {
    ...
    if (!t || 'object' != typeof t || (!e && !t.type)) return n('No type defined', t);
    var i = t.type;
    if (i && i.startsWith('custom:')) i = i.substr('custom:'.length);
    else if (e)
      if (Pt.has(i)) i = 'hui-' + i + '-row';
      else {
        if (!t.entity) return n('Invalid config given.', t);
        var r = t.entity.split('.', 1)[0];
        i = 'hui-' + (Nt[r] || 'text') + '-entity-row';
      }
    else i = 'hui-' + i + '-card';
    if (customElements.get(i)) return s(i, t);
    var o = n("Custom element doesn't exist: " + t.type + '.', t);
...
const Tt = window.loadCardHelpers ? window.loadCardHelpers() : void 0;
let Et = class extends et {
  set hass(t) {
  ...
  setConfig(t) {
    var e, n;
    if (!t.cards) throw new Error('There is no cards parameter defined');
    ((this._config = Object.assign(Object.assign({ mode: 'vertical' }, t), {
      keep: Object.assign(
        { background: !1, margin: !1, box_shadow: !1, border_radius: !1 },
        t.keep
      ),
    })),
      (null === (e = this._config.keep) || void 0 === e ? void 0 : e.margin) &&
        void 0 === (null === (n = this._config.keep) || void 0 === n ? void 0 : n.outer_padding) &&
        (this._config.keep.outer_padding = !0),
      this._createStack());
  }
  updated(t) {
    (super.updated(t),
      this._card &&
        (this._waitForChildren(this._card, !1),
        window.setTimeout(() => {
          var t, e, n, s, i;
          if (
            ((null === (e = null === (t = this._config) || void 0 === t ? void 0 : t.keep) ||
            void 0 === e
              ? void 0
              : e.background) || this._waitForChildren(this._card, !0),
            (null === (s = null === (n = this._config) || void 0 === n ? void 0 : n.keep) ||
            void 0 === s
              ? void 0
              : s.outer_padding) &&
              (null === (i = this._card) || void 0 === i ? void 0 : i.shadowRoot))
          ) {
            const t = this._card.shadowRoot.getElementById('root');
            t && (t.style.padding = '8px');
          }
        }, 500)));
  }
  async _createStack() {
  ...
  _updateStyle(t, e) {
    var n, s, i, r, o, a;
    t &&
      ((null === (s = null === (n = this._config) || void 0 === n ? void 0 : n.keep) || void 0 === s
        ? void 0
        : s.box_shadow) || (t.style.boxShadow = 'none'),
      !(null === (r = null === (i = this._config) || void 0 === i ? void 0 : i.keep) || void 0 === r
        ? void 0
        : r.background) &&
        e &&
        'true' !== getComputedStyle(t).getPropertyValue('--keep-background').trim() &&
        (t.style.background = 'transparent'),
      (null === (a = null === (o = this._config) || void 0 === o ? void 0 : o.keep) || void 0 === a
        ? void 0
        : a.border_radius) || (t.style.borderRadius = '0'));
  }
  _loopChildren(t, e) {
    t.childNodes.forEach(t => {
      var n, s;
      'STACK-IN-CARD' !== t.tagName &&
        (!(null === (s = null === (n = this._config) || void 0 === n ? void 0 : n.keep) ||
        void 0 === s
          ? void 0
          : s.margin) &&
          t.style &&
          (t.style.margin = '0px'),
        this._waitForChildren(t, e));
    });
  }
  _updateChildren(t, e) {
    if (t)
      if (t.shadowRoot) {
        const n = t.shadowRoot.querySelector('ha-card');
        if (n) this._updateStyle(n, e);
        else {
          const n = t.shadowRoot.getElementById('root') || t.shadowRoot.getElementById('card');
          if (!n) return;
          this._loopChildren(n, e);
        }
      } else
        ('function' == typeof t.querySelector &&
          t.querySelector('ha-card') &&
          this._updateStyle(t.querySelector('ha-card'), e),
          this._loopChildren(t, e));
  }
  ...
  async _createCard(t) {
    let e;
    return (
      (e = Tt ? (await Tt).createCardElement(t) : Mt(t)),
  ...
  async _rebuildCard(t, e) {
    const n = await this._createCard(e);
    return (
      t.replaceWith(n),
      (this._card = n),
      window.setTimeout(() => {
  ...
  async getCardSize() {
    return (await this._cardPromise, this._card ? await this._computeCardSize(this._card) : 0);
  }
  _computeCardSize(t) {
    return 'function' == typeof t.getCardSize
      ? t.getCardSize()
      : customElements.get(t.localName)
        ? 1
        : customElements.whenDefined(t.localName).then(() => this._computeCardSize(t));
  }
};
var kt;
(t([Z()], Et.prototype, '_card', void 0),
  t([Z()], Et.prototype, '_config', void 0),
  (Et = t(
    [
      ((kt = 'stack-in-card'),
      t =>
        'function' == typeof t
          ? ((t, e) => (window.customElements.define(t, e), e))(kt, t)
          : ((t, e) => {
              const { kind: n, elements: s } = e;
              return {
                kind: n,
                elements: s,
                finisher(e) {
