...
class ge extends ae {
  ...
  async setConfig(e) {
    ...
    for (const e of ['play', 'pause', 'ended', 'volumechange', 'canplay', 'loadeddata'])
  ...
  handleVolumeChange(e) {
    ...
    window.browser_mod.player.volume = t / 100;
  }
  handleMoreInfo(e) {
    var t, i;
    this.dispatchEvent(
  ...
  handlePlayPause(e) {
    ...
    window.browser_mod.player.ended
      ? (window.browser_mod.player.play(), window.browser_mod._show_video_player())
...
let fe = class e {
  ...
  subscribe() {
    let e, t;
    const { settlement: i } = this;
    if (null === i) {
      if (null === this.subscribers) throw new Error('Unpromise settled but still has subscribers');
      const i = (function () {
        let e, t;
        return {
  ...
  then(e, t) {
    const i = this.subscribe(),
      { unsubscribe: s } = i;
    return Object.assign(i.then(e, t), { unsubscribe: s });
  }
  catch(e) {
    const t = this.subscribe(),
      { unsubscribe: i } = t;
    return Object.assign(t.catch(e), { unsubscribe: i });
  }
  finally(e) {
    const t = this.subscribe(),
      { unsubscribe: i } = t;
    return Object.assign(t.finally(e), { unsubscribe: i });
  }
  static proxy(t) {
    const i = e.getSubscribablePromise(t);
    return typeof i < 'u' ? i : e.createSubscribablePromise(t);
  }
  ...
  static resolve(t) {
    const i =
      'object' == typeof t && null !== t && 'then' in t && 'function' == typeof t.then
        ? t
        : Promise.resolve(t);
    return e.proxy(i).subscribe();
  }
  static async any(t) {
    const i = (Array.isArray(t) ? t : [...t]).map(e.resolve);
    try {
      return await Promise.any(i);
    } finally {
      i.forEach(({ unsubscribe: e }) => {
        e();
      });
    }
  }
...
async function Ee(e, t = !1) {
  ...
  if (
    ...
    let t = 0;
    for (; 'loaded' !== e._panelState && t++ < 5; ) await new Promise(e => setTimeout(e, 100));
  }
}
async function Se(e, t, i = !1) {
  let s = [e];
  for ('string' == typeof t && (t = t.split(/(\$| )/)); '' === t[t.length - 1]; ) t.pop();
...
async function Ce() {
  ...
  const t = customElements.get('home-assistant') ? 'home-assistant' : 'hc-main';
...
const Me = async () => {
    ...
    const s = document
      ...
      ._getRoutes([{ component_name: 'lovelace', url_path: 'a' }]);
    await (null ===
      (i =
        null ===
          (t = null === (e = null == s ? void 0 : s.routes) || void 0 === e ? void 0 : e.a) ||
        void 0 === t
          ? void 0
          : t.load) || void 0 === i
      ? void 0
...
const Oe = e =>
    class extends e {
      ...
      LOG(...e) {
        ...
        const t = new Date();
        if ((console.log(`${t.toLocaleTimeString()}`, ...e), this._connected))
          try {
            this.connection.sendMessage({ type: 'browser_mod/log', message: e[0] });
          } catch (e) {
            console.log('Browser Mod: Error sending log:', e);
          }
      }
      fireBrowserEvent(e, t = void 0) {
        this.dispatchEvent(new CustomEvent(e, { detail: t, bubbles: !0 }));
      }
      async entitiesReady() {
        if (this.ready && !this.registered) return !1;
        if (Object.keys(this.browserEntities).length > 0) return !0;
        {
          let e = 0;
          for (; 0 === Object.keys(this.browserEntities).length && e++ < 20; )
            if ((await new Promise(e => setTimeout(e, 500)), this.ready && !this.registered))
              return !1;
          if (Object.keys(this.browserEntities).length > 0) return !0;
      ...
      async userReady() {
        ...
        {
          let e = 0;
          for (; !this.user && e++ < 20; ) await new Promise(e => setTimeout(e, 500));
          if (this.user) return !0;
        ...
        t(),
          e.subscribeEvents(e => {
            ...
            'browser_mod' === (null === (i = e.data) || void 0 === i ? void 0 : i.component) &&
              (this.LOG('Detected browser_mod component load'), t());
          }, 'component_loaded'),
      ...
      get config() {
        var e, t;
        return null !== (t = null === (e = this._data) || void 0 === e ? void 0 : e.config) &&
          void 0 !== t
          ? t
          : {};
      }
      get user() {
        var e;
        return null === (e = this.hass) || void 0 === e ? void 0 : e.user;
      }
      get browsers() {
        var e, t;
        return null !== (t = null === (e = this._data) || void 0 === e ? void 0 : e.browsers) &&
          void 0 !== t
          ? t
          : [];
      }
      get registered() {
        var e;
        return (
          void 0 !== (null === (e = this.browsers) || void 0 === e ? void 0 : e[this.browserID])
        );
      }
      get browser_locked() {
        var e, t;
        return null ===
          (t = null === (e = this.browsers) || void 0 === e ? void 0 : e[this.browserID]) ||
          void 0 === t
          ? void 0
          : t.locked;
      }
      ...
      async _reregister(e = {}) {
        await this.connection.sendMessage({
          type: 'browser_mod/register',
          browserID: this.browserID,
          data: Object.assign(Object.assign({}, this.browsers[this.browserID]), e),
        });
      }
      get global_settings() {
        var e, t;
        const i = {},
          s =
            null !== (t = null === (e = this._data) || void 0 === e ? void 0 : e.settings) &&
            void 0 !== t
              ? t
              : {};
        for (const [e, t] of Object.entries(s)) null !== t && (i[e] = t);
        return i;
      }
      get user_settings() {
        var e, t, i, s;
        const o = {},
          n =
            null !==
              (s =
                null ===
                  (t = null === (e = this._data) || void 0 === e ? void 0 : e.user_settings) ||
                void 0 === t
                  ? void 0
                  : t[null === (i = this.user) || void 0 === i ? void 0 : i.id]) && void 0 !== s
              ? s
              : {};
        for (const [e, t] of Object.entries(n)) null !== t && (o[e] = t);
        return o;
      }
        ...
        const s = {},
          o =
            null !==
              ...
              ? i
              : {};
        for (const [e, t] of Object.entries(o)) null !== t && (s[e] = t);
        return s;
      }
      get settings() {
        return Object.assign(
          Object.assign(Object.assign({}, this.global_settings), this.browser_settings),
          this.user_settings
        );
      }
      set_setting(e, t, i) {
        ...
        switch (i) {
          case 'global':
            this.connection.sendMessage({ type: 'browser_mod/settings', key: e, value: t });
            break;
          case 'user': {
            const i = this.user.id;
      ...
      get playerEnabled() {
        ...
        return this.registered
          ? null !==
              (i =
                null ===
                  (t = null === (e = this.browserEntities) || void 0 === e ? void 0 : e.player) ||
                void 0 === t
                  ? void 0
                  : t.enabled) &&
              void 0 !== i &&
      ...
      get screenEnabled() {
        ...
        return this.registered
          ? null !==
              (i =
                null ===
                  (t = null === (e = this.browserEntities) || void 0 === e ? void 0 : e.screen) ||
                void 0 === t
                  ? void 0
                  : t.enabled) &&
              void 0 !== i &&
      ...
      sendUpdate(e) {
        if (this.ready && this.registered) {
          ...
          try {
            ...
            console.log('Browser Mod: Error sending update:', e);
          }
        }
      }
          ...
          this.addEventListener(
            ...
            () => {
              this.entitiesReady()
                ...
                .catch(e => {
                  console.warn(
                    `Browser Mod: ${e}. Timeout waiting for browser entities to be ready. Screen light sensor will not be available`
                  );
                });
            },
            { once: !0 }
          ...
          this.videoInteraction.then(() => {
            ...
            this.addEventListener('command-player-play', e => {
              ...
              (this.player.src ||
                ...
                (null === (s = e.detail) || void 0 === s ? void 0 : s.media_type) &&
                  ((
                    null === (o = e.detail) || void 0 === o
                      ? void 0
                      : o.media_type.startsWith('video')
                  )
                    ? (this.player = this._video_player)
                    : (this.player = this._audio_player)),
                (null === (n = e.detail) || void 0 === n ? void 0 : n.media_content_id) &&
                  (this.player.src = e.detail.media_content_id),
                (this.extra = null === (r = e.detail) || void 0 === r ? void 0 : r.extra),
                this.player.play(),
            ...
            this.addEventListener('command-player-set-volume', e => {
              var t;
              void 0 !== (null === (t = e.detail) || void 0 === t ? void 0 : t.volume_level) &&
                (this.player.volume = e.detail.volume_level);
            }),
            this.addEventListener('command-player-mute', e => {
              var t;
              void 0 !== (null === (t = e.detail) || void 0 === t ? void 0 : t.mute)
          ...
          ? ($e(document, 'home-assistant $ dialog-media-player-browse').then(e =>
            ...
            this.showPopup(
              Object.assign(
                ...
                null === (e = this.extra) || void 0 === e ? void 0 : e.popup
              )
            ))
          : this.player !== this._video_player &&
      ...
      _player_update() {
        ...
        this.sendUpdate({
          player: {
            ...
            extra: Object.assign(Object.assign({}, this.extra), {
              videoInteractionRequired: !this._canPlayVideo,
              audioInteractionRequired: !this._canPlayAudio,
            }),
          },
        });
      }
    ...
    class extends e {
      ...
      async update_camera() {
        ...
        if (!this.cameraEnabled) {
          const t = null === (e = this._cameraVideo) || void 0 === e ? void 0 : e.srcObject;
          return void (
            t && (t.getTracks().forEach(e => e.stop()), (this._cameraVideo.srcObject = void 0))
          );
        }
        if (this.fully) this.sendUpdate({ camera: this.fully_camera });
        else if (null === (t = this._cameraVideo) || void 0 === t ? void 0 : t.videoWidth) {
    ...
    class extends e {
      constructor() {
        super(),
          ...
          (this.audioInteraction = new Promise(e => {
            this._audioInteractionResolve = e;
          })),
          this.addEventListener(
            'browser-mod-user-ready',
            () => {
              this.entitiesReady()
                .then(() => {
                  (!this.playerEnabled && !this.cameraEnabled) ||
                    this._versionNotificationPending ||
                    ((this._audioRequired = this.playerEnabled), this.setupInteraction());
                })
                .catch(e => {
                  console.warn(
                    `Browser Mod: Failed to wait for browser entities to be ready. Player will be unavailable. Error: ${e}`
                  );
                });
            },
            { once: !0 }
    ...
    class extends e {
      ...
      get fully_screen() {
        ...
        return (
          ...
          (null === (e = window.fully) || void 0 === e ? void 0 : e.getScreenOn())
        );
      }
      set fully_screen(e) {
        var t, i, s;
        e
          ...
          : null === (s = window.fully) || void 0 === s || s.turnScreenOff();
      }
      get fully_brightness() {
        var e;
        return null === (e = window.fully) || void 0 === e ? void 0 : e.getScreenBrightness();
      }
      ...
      get fully_camera() {
        var e;
        return null === (e = window.fully) || void 0 === e ? void 0 : e.getCamshotJpgBase64();
      }
      get fully_data() {
  ...
  Ye = e =>
    class extends e {
      ...
      _browser_state_update() {
        (async () => {
          var e, t, i, s, o, n, r, a;
          const l = navigator.getBattery ? await navigator.getBattery() : void 0;
          this.sendUpdate({
            browser: {
              path: window.location.pathname,
              visibility: document.visibilityState,
              userAgent: navigator.userAgent,
              currentUser: null === (e = this.user) || void 0 === e ? void 0 : e.name,
              ...
              battery_level:
                null !==
                  (i =
                    null === (t = window.fully) || void 0 === t ? void 0 : t.getBatteryLevel()) &&
                void 0 !== i
                  ? i
                  : 100 * (null == l ? void 0 : l.level),
              charging:
                null !==
                  (o = null === (s = window.fully) || void 0 === s ? void 0 : s.isPlugged()) &&
                void 0 !== o
                  ? o
                  : null == l
                  ? void 0
              ...
              darkMode:
                ...
                void 0 === r
                  ...
                  : r.darkMode,
              userData: this.user,
              ip_address: null === (a = window.fully) || void 0 === a ? void 0 : a.getIp4Address(),
      ...
      const i = (t, i) => (e.set(i, t), t),
        s = o => {
          ...
          switch (n) {
            ...
            case 2: {
              const e = i({}, o);
              for (const [t, i] of r) e[s(t)] = s(i);
              return e;
            }
            case 3:
              return i(new Date(r), o);
            case 4: {
              const { source: e, flags: t } = r;
              return i(new RegExp(e, t), o);
            }
            case 5: {
              const e = i(new Map(), o);
              for (const [t, i] of r) e.set(s(t), s(i));
              return e;
            }
            case 6: {
              const e = i(new Set(), o);
              for (const t of r) e.add(s(t));
              return e;
            }
            case 7: {
            ...
            case 8:
              return i(BigInt(r), o);
            case 'BigInt':
              return i(Object(BigInt(r)), o);
            case 'ArrayBuffer':
              return i(new Uint8Array(r).buffer, r);
            case 'DataView': {
              const { buffer: e } = new Uint8Array(r);
        ...
        const o = (e, t) => {
          ...
          n = s => {
            ...
            switch (r) {
                ...
                if (a) {
                  ...
                  return (
                    'DataView' === a
                      ...
                      : 'ArrayBuffer' === a && (e = new Uint8Array(s)),
                    o([a, [...e]], s)
                  );
                }
                const e = [],
                  t = o([r, e], s);
                for (const t of s) e.push(n(t));
                return t;
              }
              case 2: {
                if (a)
                  switch (a) {
                    case 'BigInt':
                      return o([a, s.toString()], s);
                    case 'Boolean':
                    case 'Number':
                    case 'String':
                      return o([a, s.valueOf()], s);
                  }
              ...
              case 3:
                return o([r, s.toISOString()], s);
              case 4: {
                const { source: e, flags: t } = s;
                return o([r, { source: e, flags: t }], s);
              }
              case 5: {
                const t = [],
                  i = o([r, t], s);
  ...
  for (const i of e.views) {
    if (i.cards)
      for (const e of i.cards) {
        if (e.popup_card_id === t) return e;
        if (e.cards) for (const i of e.cards) if (i.popup_card_id === t) return i;
      }
    if (i.sections)
      for (const e of i.sections)
        if (e.cards)
          for (const i of e.cards) {
            if (i.popup_card_id === t) return i;
            if (i.cards) for (const e of i.cards) if (e.popup_card_id === t) return e;
          }
  }
  return null;
}
const it = e =>
    class extends e {
      ...
      async service(e, t) {
        this._service_action({ service: e, data: t, target: {} });
      }
      async _service_action({ service: e, data: t, target: i }) {
        ...
        let r = e;
        if (
          (!r.startsWith('browser_mod.') && r.includes('.')) ||
          void 0 !== t.browser_id ||
          void 0 !== t.user_id
        ) {
        ...
        switch ((r.startsWith('browser_mod.') && (r = r.substring(12)), r)) {
          case 'sequence':
          ...
          case 'delay':
            ...
            break;
          case 'more_info':
            const { entity: e, view: i, large: r, ignore_popup_card: u, close: p } = t;
            this.showMoreInfo(e, i, r, u, p);
            break;
          case 'popup':
            if (t.popup_card_id) {
              const e = await xe(document),
                i = await (async function (e, t) {
                  var i;
                  const s =
                    null === (i = null == e ? void 0 : e.lovelace) || void 0 === i
                      ? void 0
                      : i.config;
                  var o = void 0,
                    n = void 0;
                  ...
                  if (s && o && !n) r = tt(s, o);
                    ...
                    var a;
                    try {
                      a = await window.browser_mod.connection.sendMessagePromise({
          ...
          case 'notification':
            ...
            break;
          case 'close_popup':
            await this.closePopup(t);
            break;
          case 'set_popup_style':
            this.setPopupStyle(t);
            break;
          case 'navigate':
          ...
          case 'change_browser_id':
            {
              const { current_browser_id: e, new_browser_id: i, register: r, refresh: a } = t;
              if (void 0 === e && void 0 === i) {
                const e = 'Change Browser ID',
                  t = Object.keys(this.browsers),
                  i = [
                    {
                    ...
                    },
                    {
                      ...
                      selector: { select: { options: t, custom_value: !0, sort: !0 } },
                    },
                    {
                      name: 'register',
                      label: 'Register',
                  ...
                  o = {
                    ...
                    right_button_action: e => {
                      this.fireBrowserEvent('command-change_browser_id', e);
                    },
                  };
                null === (s = window.browser_mod) ||
                  void 0 === s ||
                  s.showPopup(Object.assign({ title: e, content: i }, o));
              } else {
                let t = !1;
                if (e && this.browserID === e) t = !0;
                else {
                  const i =
                    null ===
                      (n = null === (o = this.hass) || void 0 === o ? void 0 : o.devices[e]) ||
                    void 0 === n
                      ? void 0
                      : n.identifiers;
                  Array.isArray(i) &&
          ...
          case 'set_theme':
            {
              ...
              if (
                ...
                const [t, i, s] = e.primaryColor;
                e.primaryColor = '#' + ((1 << 24) + (t << 16) + (i << 8) + s).toString(16).slice(1);
              }
...
class ft {
    ...
    (this._settingsValid = !0),
      ...
      (this._formObjectSelectors = e => {
        var t,
          ...
          s = [];
        const o =
          null === (t = null == e ? void 0 : e.shadowRoot) || void 0 === t
            ? void 0
            : t.querySelectorAll('ha-selector');
        null == o ||
          o.forEach(e => {
            if (null == e ? void 0 : e.selector.hasOwnProperty('object')) {
              const t = { element: e, name: e.name, label: e.label };
              s.push(t);
            }
          });
        const n =
          null === (i = null == e ? void 0 : e.shadowRoot) || void 0 === i
            ? void 0
            : i.querySelectorAll('ha-form-grid, ha-form-expandable');
        return (
          null == n ||
            n.forEach(e => {
              if (e.shadowRoot) {
                e.shadowRoot.querySelectorAll('ha-form').forEach(e => {
                  const t = this._formObjectSelectors(e);
                  s.push(...t);
                });
              }
            }),
  ...
  get objectSelectors() {
    var e;
    return null !== (e = this._objectSelectors) && void 0 !== e ? e : [];
  }
  set showErrors(e) {
    var t;
    (this._showErrors = e),
...
class yt extends ae {
      ...
      customElements.whenDefined('card-mod').then(() => {
        ...
        null ===
          ...
          t.call(
            ...
            (null === (i = this.card_mod) || void 0 === i ? void 0 : i.style)
              ? {
                  style: this.card_mod.style,
                  debug:
                    null !==
                      (o = null === (s = this.card_mod) || void 0 === s ? void 0 : s.debug) &&
                    void 0 !== o &&
                    o,
                }
              : {
  ...
  _updateStyleAttributes(e) {
    ...
    'initial' == e && (e = this._initialStyle),
      ...
      null === (t = this._popupStyles) ||
        void 0 === t ||
        t.forEach(t => {
          var i;
          t.style === e &&
            (null === (i = t.include_styles) ||
              void 0 === i ||
              i.forEach(e => {
                this._styleAttributes[e] = !0;
              }));
  ...
  _setFormdata(e) {
    for (const t of e)
      t.schema
        ? this._setFormdata(t.schema)
        : t.name && void 0 !== t.default && (this._formdata[t.name] = t.default);
  }
  async setupDialog(
    e,
    t,
  ...
  async _icon_action(e) {
    ...
    (null === (t = this._actions) || void 0 === t ? void 0 : t.dismiss_action) &&
      ...
      (null === (s = null === (i = this.icons) || void 0 === i ? void 0 : i[e]) || void 0 === s
        ? void 0
        : s.close) && (await this.do_close()),
      await (null ===
        (r =
          null === (n = null === (o = this.icons) || void 0 === o ? void 0 : o[e]) || void 0 === n
            ? void 0
            : n.action) || void 0 === r
        ? void 0
        : r.call(n));
    ...
    class extends e {
      ...
      get openPopups() {
        return this._popupElements
          .filter(e => !0 === e.open)
          .map(e => (void 0 !== e.tag ? e.tag : 'standard'));
      }
      get popupState() {
        return this._popupElements.some(e => !0 === e.open);
      }
      showPopup(e) {
        (async () => {
          const t = await Ce(),
        ...
        if (o) {
          ...
          (n.dispatchEvent(
            new CustomEvent('hass-more-info', {
              ...
              composed: !0,
              cancelable: !1,
              detail: { entityId: e, view: t, ignore_popup_card: s },
            })
          ),
          i)
        ) {
      ...
      setPopupStyle(e) {
        const { all: t, tag: i, style: s, direction: o } = e;
        if (!0 === t)
          this._popupElements.forEach(e => {
            s ? e._setStyleAttribute(s) : e._cycleStyleAttributes(o);
          });
        else if ('string' == typeof i) {
          const e = '' != i ? `browser-mod-popup-${i}` : 'browser-mod-popup',
            t = this._popupElements.find(t => t.nodeName.toLowerCase() === e);
          s ? null == t || t._setStyleAttribute(s) : null == t || t._cycleStyleAttributes(o);
        } else {
          const e = this._popupElements.slice(-1)[0];
          s ? null == e || e._setStyleAttribute(s) : null == e || e._cycleStyleAttributes(o);
        }
      }
    },
  Et = {};
  ...
  Ct = [
    ...
    { name: 'title', label: 'Title', selector: { text: {} } },
    {
      ...
      schema: [
        {
          label:
            'Multiple icons can be specified as a yaml list. Refer to Browser Mod documentation.',
          type: 'constant',
        },
        { name: 'icon', label: 'Icon', selector: { icon: {} } },
        { name: 'icon_title', label: 'Icon title', selector: { text: {} } },
        { name: 'icon_action', label: 'Icon action', selector: { object: {} } },
        { name: 'icon_close', label: 'Icon closes popup', default: !0, selector: { boolean: {} } },
        { name: 'icon_class', label: 'Icon class', selector: { text: {} } },
      ],
    },
    {
      type: 'expandable',
      ...
      schema: [
        {
          ...
          selector: {
            select: { mode: 'dropdown', options: ['accent', 'filled', 'outlined', 'plain'] },
          },
        },
        {
    ...
    },
    {
      type: 'grid',
      schema: [
        { name: 'right_button_action', label: 'Right button action', selector: { object: {} } },
        { name: 'left_button_action', label: 'Left button action', selector: { object: {} } },
      ],
    },
    {
      type: 'grid',
    ...
    },
    {
      type: 'grid',
      schema: [
        { name: 'dismissable', label: 'User dismissable', selector: { boolean: {} } },
        {
          name: 'timeout',
    ...
    },
    {
      type: 'grid',
      schema: [
        { name: 'dismiss_action', label: 'Dismiss action', selector: { object: {} } },
        { name: 'timeout_action', label: 'Timeout action', selector: { object: {} } },
      ],
    },
    {
    ...
    },
    {
      ...
      schema: [
        { name: 'tag', label: 'Tag', selector: { text: {} } },
        { name: 'dismiss_icon', label: 'Popup dismiss/close icon', selector: { icon: {} } },
      ],
    },
  ];
class qt extends ae {
  ...
  firstUpdated(e) {
    this.updateComplete.then(async () => {
      ...
      null == i || i.addEventListener('click', this._handleClickAwayFromSettings.bind(this));
    });
  }
  async getUpdateComplete() {
    const e = new Promise(e => {
      const t = () => {
        var i;
        const s =
          null === (i = this.shadowRoot) || void 0 === i ? void 0 : i.querySelector('ha-form');
        s ? e(s.updateComplete) : setTimeout(t, 100);
      };
      t();
    });
    return Promise.all([e, super.getUpdateComplete()]).then(() => !0);
  }
  _handleClickAwayFromSettings(e) {
      ...
      return (
        ...
        void this.dispatchEvent(
          new CustomEvent('hass-notification', {
            detail: {
              message:
                'Settings are not valid. Please fix the errors before\n              before continuing.',
            },
            bubbles: !0,
            composed: !0,
          })
...
class It extends ae {
  ...
  static getStubConfig(e, t) {
    return {
      ...
      card: {
        type: 'markdown',
        content:
          'This card can be used in browser_mod.popup service or to replace the more-info dialog',
      },
    };
  }
  setConfig(e) {
  ...
  setHidden(e) {
    this.hasAttribute('hidden') !== e &&
      (this.toggleAttribute('hidden', e),
      this.dispatchEvent(new Event('card-visibility-changed', { bubbles: !0, composed: !0 })));
  }
  static get styles() {
    return a`
      ha-card {
      ...
      window.addEventListener('hass-more-info', e => {
        ...
        if (
          ...
          ((null === (s = e.detail) || void 0 === s ? void 0 : s.view) &&
            'info' !== (null === (o = e.detail) || void 0 === o ? void 0 : o.view)) ||
          (!(null === (n = e.detail) || void 0 === n ? void 0 : n.entityId) &&
            !(null === (r = e.detail) || void 0 === r ? void 0 : r.target)) ||
          !i
        )
          return;
...
class Mt extends ae {
  ...
  _renderDynamicStyles() {
    let e = ':host {\n';
    return (
      void 0 !== this.top && (e += `  top: ${this.top}px;\n`),
...
const Tt = e => {
    class i extends e {
            ...
            this.addEventListener(
              ...
              () => {
                this.entitiesReady()
                  ...
                  .catch(e => {
                    console.warn(
                      `Browser Mod: ${e}. Timeout waiting for browser entities to be ready. Default action not run.`
                    );
                  });
              },
              { once: !0 }
      ...
      async _hideHeader() {
        ...
        if (n) o = n.querySelector('ha-menu-button');
          ...
          for (; r && 'ha-top-app-bar-fixed' !== r.localName && i++ < 5; ) {
            ...
            const i =
              null !==
                (t =
                  null !== (e = r.querySelector('ha-top-app-bar-fixed')) && void 0 !== e
                    ? e
        ...
        return n && !0 === this.settings.hideHeader
          ? (s.style.setProperty('--header-height', '0px'),
            ...
            !0)
          : !(!o || !0 !== this.settings.hideSidebar) &&
              (null === (i = o.remove) || void 0 === i || i.call(o), !0);
      }
      _runDefaultAction() {
      ...
      async _setupOverlayIcon() {
        ...
        this.settings.overlayIcon
          ? this._overlayIcon ||
            ...
            this._updateOverlayIcon())
          : (null === (e = this._overlayIcon) || void 0 === e || e.remove(),
            (this._overlayIcon = void 0));
      }
      async _updateOverlayIcon() {
        ...
        if (this.settings.overlayIcon && this._overlayIcon) {
          const s =
            null ===
              (t =
                null === (e = window.location.pathname) || void 0 === e ? void 0 : e.split('/')) ||
            void 0 === t
              ? void 0
              : t[1];
          s &&
            ((
              null === (i = this.settings.overlayIcon.panels) || void 0 === i
                ? void 0
                : i.includes(s)
            )
              ? (this._overlayIcon.show = '')
              : (this._overlayIcon.show = void 0));
        }
      }
          ...
          e &&
            e.addEventListener('show-dialog', t => {
              ...
              if (
                ...
                if (
                  (t.stopPropagation(),
                  (null === (o = this.hass.user) || void 0 === o ? void 0 : o.is_admin) ||
                    !this.registered)
                ) {
                  const i = new CustomEvent('show-dialog', {
                    bubbles: !0,
                    composed: !0,
                    detail: Object.assign({ browser_mod_continue: !0 }, t.detail),
                  });
                  null === (n = window.browser_mod) ||
                    void 0 === n ||
                    n.showPopup({
                  ...
                  const e = 'browser_mod.notification',
                    t =
                      'Sidebar settings are managed by owner/admin using Browser Mod integration.',
                    i = 5e3,
                    s = !0;
                  this.service(e, { message: t, duration: i, dismissable: s });
                }
              }
            }),
      ...
      getSetting(e) {
        ...
        for (const [t, o] of Object.entries(
          ...
          null != (null === (s = o.settings) || void 0 === s ? void 0 : s[e]) &&
            (n.browser[t] = o.settings[e]);
        for (const [t, i] of Object.entries(
          null !== (o = this._data.user_settings) && void 0 !== o ? o : {}
        ))
      ...
      setSetting(e, t, i) {
        if ('global' === e)
          ...
          const e = this._data.browsers[t],
            s = Object.assign(Object.assign({}, e.settings), i);
          this.connection.sendMessage({
            type: 'browser_mod/register',
            browserID: t,
            data: Object.assign(Object.assign({}, e), { settings: s }),
          });
        } else if ('user' === e) {
          const e = t;
      ...
      set browserID(e) {
        '' === e &&
          (e = (function () {
            ...
            return (
              'browser_mod_' +
              ((null === (e = window.fully) || void 0 === e ? void 0 : e.getDeviceId())
                ? window.fully.getDeviceId().replace(/-/g, '_')
                : `${t()}${t()}_${t()}${t()}`)
            );
          })());
  ...
  Rt = e =>
    class extends e {
      ...
      async _checkVersion() {
        var e;
        (null === (e = this._data) || void 0 === e ? void 0 : e.version) &&
          this._data.version !== this._version &&
          (this._versionNotificationPending ||
            ((this._versionNotificationPending = !0),
      ...
      async _localNotification(e, t) {
        ...
        const s = {
          ...
          action_text: 'Reload',
          browser_id: 'THIS',
          action: { service: 'browser_mod.refresh', data: { browser_id: 'THIS' } },
        };
    ...
    class extends e {
      constructor() {
        super(),
          ...
          ['browser-mod-ready', 'browser-mod-popup-opened', 'browser-mod-popup-closed'].forEach(
            e => {
      ...
      _panelTitle(e) {
        ...
        if (null === (t = null == e ? void 0 : e.hass) || void 0 === t ? void 0 : t.localize) {
          const t = this._getPanelNameTranslationKey(e.panel);
          return (
            e.hass.localize(t) || (null === (i = e.panel) || void 0 === i ? void 0 : i.title) || ''
          );
        }
        return (
          (null === (s = null == e ? void 0 : e.panel) || void 0 === s ? void 0 : s.title) || ''
        );
      }
      _panelAttributes(e) {
        var t, i, s, o, n;
        return {
          panelTitle: this._panelTitle(e),
          panelUrlPath:
            (null ===
              (i =
                null === (t = null == e ? void 0 : e.route) || void 0 === t ? void 0 : t.prefix) ||
            void 0 === i
              ? void 0
              : i.replace(/^\/|\/$/g, '')) || '',
          panelComponentName:
            (null === (s = null == e ? void 0 : e.panel) || void 0 === s
              ? void 0
              : s.component_name) || '',
          panelIcon:
          ...
          panelRequireAdmin:
            (null === (n = null == e ? void 0 : e.panel) || void 0 === n
              ? void 0
              : n.require_admin) || !1,
        };
      }
      async _viewAttributes(e) {
        var t, i, s, o, n, r, a, l, d, c;
        if (
          'lovelace' !==
          (null === (t = null == e ? void 0 : e.panel) || void 0 === t ? void 0 : t.component_name)
        )
          return {
            viewTitle: '',
            viewUrlPath:
              (null ===
                (s =
                  null === (i = null == e ? void 0 : e.route) || void 0 === i ? void 0 : i.path) ||
              void 0 === s
                ? void 0
                : s.replace(/^\/|\/$/g, '')) || '',
            viewNarrow: (null == e ? void 0 : e.narrow) || !1,
          };
        let h = 0;
        for (
          ;
        ...
        return {
          viewTitle:
            (null ===
              (a =
                null === (r = null === (n = u.config) || void 0 === n ? void 0 : n.views) ||
                void 0 === r
                  ? void 0
                  : r[p]) || void 0 === a
              ? void 0
          ...
          viewUrlPath:
            (null ===
              (c =
                null === (d = null === (l = u.config) || void 0 === l ? void 0 : l.views) ||
                void 0 === d
                  ? void 0
                  : d[p]) || void 0 === c
              ? void 0
      ...
      _panel_state_update() {
        this._isUpdating ||
          (async () => {
            var e, t;
            this._isUpdating = !0;
            const i = await this._getPanel(document),
            ...
            s.panelUrlPath && r.push(s.panelUrlPath),
              ...
              this.sendUpdate({
                panel: {
                  title: n.join(' - '),
                  attributes: Object.assign(Object.assign(Object.assign({}, s), o), {
                    fullUrlPath: r.join('/'),
                    popupOpen:
                      null === (e = window.browser_mod) || void 0 === e ? void 0 : e.popupState,
                    openPopups:
                      null === (t = window.browser_mod) || void 0 === t ? void 0 : t.openPopups,
                  }),
                },
              }),
              (this._isUpdating = !1);
